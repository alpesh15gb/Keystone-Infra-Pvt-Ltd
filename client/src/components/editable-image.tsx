...
export function EditableImage({
    ...
    if (file && file.type.startsWith('image/')) {
      ...
      try {
        await fetch('/api/content', {
          ...
          body: JSON.stringify({ id, content: imageUrl })
        });
      } catch (error) {
  ...
  const triggerFileSelect = () => {
    ...
    fileInput.onchange = (e) => handleFileSelect(e as any);
    fileInput.click();
  };

  return (
    <div
      className={cn("relative group h-full w-full", isEditMode && "cursor-pointer")}
