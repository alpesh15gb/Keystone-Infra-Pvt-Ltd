...
export function BuildingProjectsGallery({ isEditMode = false }: BuildingProjectsGalleryProps) {
  const buildingProjects: BuildingProject[] = [
    ...
    {
      id: 'building-5',
      imageSrc: 'https://customer-assets.emergentagent.com/job_nh63-engineering/artifacts/7e1m55bs_5.jpg',
  ...
  {
    id: 'building-6',
    imageSrc: 'https://customer-assets.emergentagent.com/job_nh63-engineering/artifacts/xvb58qcy_6.jpg',
